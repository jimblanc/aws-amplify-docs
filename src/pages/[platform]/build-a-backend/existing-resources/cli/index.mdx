...
This guide shows you how to connect new mobile and web apps to AWS resources you've already created using the AWS Amplify CLI (Command Line Interface). The Amplify CLI provides a simple workflow for provisioning cloud resources like authentication, databases, and storage for mobile and web apps through the command line. By following the [first part](/[platform]/build-a-backend/existing-resources/cli/#connect-mobile-app-to-existing-aws-resources) of the guide, you will learn how to connect a new Flutter mobile app to pre-existing backend resources set up through Amplify. The [second part](/[platform]/build-a-backend/existing-resources/cli/#connect-a-web-app-to-existing-aws-resources) of the guide covers how to do the same for a React web app. 
