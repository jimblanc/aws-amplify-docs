...
From the Cognito user pool console page that opened in your default browser, choose `Users and groups` tab in `General settings`. Then, choose the corresponding Cognito group from the `Groups` tab on the right as shown  
