...
export const meta = {
  ...
  description: 'Learn more about the foundational auth concepts for cloud-based applications and how they work with Amplify.',
  platforms: [
    'javascript',
    'android',
    'swift',
