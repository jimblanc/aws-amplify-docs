...
In-App Messaging also integrates seamlessly with [Amplify Analytics](/[platform]/prev/build-a-backend/more-features/analytics/set-up-analytics/). Once you’ve set up an In-App Messaging campaign (through [Amazon Pinpoint](https://aws.amazon.com/pinpoint/)), simply sync messages to your user’s device and recorded analytics events will automatically start working as trigger events to display in-app messages to your users.
