...
import android3 from '/src/fragments/lib/auth/android/device_features/20_forgetDevice.mdx';
...
import ios4 from '/src/fragments/lib/auth/ios/device_features/30_fetchDevice.mdx';

<Fragments fragments={{ swift: ios4 }} />

import android5 from '/src/fragments/lib/auth/android/device_features/30_fetchDevice.mdx';
